 ...
 * Author: Elton Boehnen: Reactive BEJSON-Native State Manager (v1.0)
 * Date: 2026-05-03
 * 
 * Merges high-performance proxy reactivity with native 104db serialization.
 */
...
class SwitchState {
    constructor(initialState = {}, options = {}) {
        this.schema_name = options.name || "SwitchState";
        this.bejson = Switch.BEJSON.create104db(this.schema_name, ["StateNode", "History"], [
