...
Status:      OFFICIAL — BEJSON/Lib (v1.9)
Author:      Elton Boehnen
Version:     1.9 OFFICIAL
Date:        2026-05-06
Description: Authoritative HTML/CSS skeleton templates for Core-Command.
             Updated: Implemented word-break and overflow-wrap for titles.
"""
...
.sidebar {{
    ...
    height: calc(100vh - 40px); background-color: var(--bg-page);
...
.data-table, .b-table {{ 
    ...
    font-size: 0.85rem; background: var(--bg-surface);
}}
.data-table th, .b-table th {{ 
...
/* Square Buttons */
.form__button, .b-button {{
    background: var(--primary); color: white;
    padding: 10px 20px; border-radius: 0; font-weight: 800;
...
<body>
    ...
    <footer class="status-footer">
        ...
        <div>ELTON BOEHNEN &copy; 2026</div>
    </footer>
