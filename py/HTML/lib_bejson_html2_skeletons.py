...
/* SECTION 2.5: SUBTABS */
.subtabs { display: flex; gap: 8px; margin-bottom: 24px; border-bottom: 1px solid var(--border); padding-bottom: 8px; }
.subtabs__btn {
...
.subtabs__btn:hover { color: var(--primary-red); }
.subtabs__btn--active {
    color: var(--primary-red); border-color: var(--primary-red);
    font-weight: bold; background: rgba(222, 38, 38, 0.05);
}
"""
...
<body>
    <header class="top-bar">
        <div class="top-bar__brand">SWITCH <span class="top-bar__brand--accent">CORE</span> HUB</div>
        <button class="top-bar__toggle" aria-label="Toggle Menu">&#9776;</button>
    </header>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.switchSubTab = (tabId) => {
                ...
                document.querySelectorAll(".subtabs__btn").forEach(b => b.classList.remove("subtabs__btn--active"));
                ...
                if (evt && evt.currentTarget && evt.currentTarget.classList) {
                    evt.currentTarget.classList.add("subtabs__btn--active");
                }
            };
